      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-aistech-blue mb-4">Aistech</h3>
            <p className="text-gray-300 mb-4">
              Your trusted partner in custom software development and technology solutions.
              We transform ideas into powerful, scalable applications.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-aistech-blue transition-colors">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Aistech. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
